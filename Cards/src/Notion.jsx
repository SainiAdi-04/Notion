...
const BurnBarrel=({setCards})=>{
    ...
    return (
        <div
            ...
            {active?
            <FaFire className='animate-bounce'/>:<FiTrash/>
            }
        </div>
    )
}
...
const AddCard=({column,setCards})=> {
    ...
    return (
        <>
            ...
            </motion.form>:<motion.button layout onClick={()=>setAdding(true)}
            className='flex w-full items-center gap-1.5 px-3 py-1.5 ttext-xs text-neutral-400 transition-colors hover:text-neutral-50'>
                <span>Add Card</span>
                <FiPlus/>
            </motion.button>}
        </>
